...
class SDMINOv002Att(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, IPAdapterMixin, FromSingleFileMixin):
    r"""
    ...
    def __call__(
        ...
        cfg: Dict,                
        texture_indices= Optional[Union[List[int], List[List[int]]]],
    ...
    def compute_ba_mask_loss(
        ...
        if is_cross:
            ...
            if isinstance(token_indices[0], list): #NOTE 1109 att ver
