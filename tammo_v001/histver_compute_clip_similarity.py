...
from eval.imagenet_utils import get_embedding_for_prompt, imagenet_templates
import logging
import time
...
if __name__ == '__main__':
    ...
    start = time.time()
    output_path = '/home/initno1/exp/mino_v002/20241104_090050'
    name = output_path.split('v002/')[-1]
    metrics_save_path = f'/home/initno1/GSN/mino_v002/hist_test_v003/{name}_eval_ti-sim/'
