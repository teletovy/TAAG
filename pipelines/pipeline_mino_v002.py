...
class SDMINOv002(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin, IPAdapterMixin, FromSingleFileMixin):
    r"""
    ...
    def __call__(
        ...
        return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept), {
            ...
            'nsfw': has_nsfw_concept[0], 'mask_construct': mask_construct
        }, mask_anormaly
